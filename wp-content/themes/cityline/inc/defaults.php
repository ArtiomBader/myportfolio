...
$cityline_title                         = __( 'creative&nbsp;<br><span style="color:rgba(var(--kubio-color-1),1)" class="kubio-has-inline-color">design</span> agency', 'cityline' );
$cityline_subtitle                      = __( 'Morbi egestas id est vel elementum. In ultrices viverra est sed blandit. Aenean posuere orci magna, sit amet rutrum nulla euismod sed.','cityline' );
$cityline_theme_action_button           = __( 'Button 1', 'cityline' );
$cityline_theme_action_button_secondary = __( 'BUtton 2', 'cityline' );
